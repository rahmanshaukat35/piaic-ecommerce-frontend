  ...
  return (
    <main className="lg:px-20 px-5 max-w-[1540px] mx-auto mt-20">
      <div className="grid grid-cols-[5rem,1fr] bs:grid-cols-[10rem,1fr] lg:grid-cols-[10rem,1fr,1fr] px-10 lg:px-0 gap-1">
        ...
        <div className="flex flex-col justify-start py-5 items-start col-span-2 lg:col-span-1 lg:ml-5">
          <h3 className="text-2xl font-bold">{product.name}</h3>
          <p className="text-gray-400 text-xl font-semibold">
            {product.subcat}
          </p>
          <p className="md:mt-16 mt-8 mb-3 text-xl font-bold">Select Size</p>
